class ContaminationstatusesController < ApplicationController
  ...
  private
    ...
    def contaminationstatus_params
      params.require(:contaminationstatus).permit(:cfu_natural_contamination, :cfu_natural_contamination_unit, :matrix_id, :agent_id, :tenacity_id, :treatment_id, :spiking_id, :samplepreparation_id, :detection_id, :reference_id, :user_id)
    end
end
